          ...
          <div className="grid grid-cols-2 gap-2 mt-3">
            {totalDebt > 0 && (
              <div className="rounded-xl border border-rose-200/60 bg-rose-50/70 p-2">
                <p className="text-xs text-ink-500 dark:text-ink-400">{t(language, 'debt')}</p>
            ...
            {totalBills > 0 && (
              <div className="rounded-xl border border-amber-200/60 bg-amber-50/70 p-2">
                <p className="text-xs text-ink-500 dark:text-ink-400">{t(language, 'bills')}</p>
            ...
            {totalSavings > 0 && (
              <div className="rounded-xl border border-teal-200/60 bg-teal-50/70 p-2">
                <p className="text-xs text-ink-500 dark:text-ink-400">{t(language, 'savings')}</p>
            ...
            {totalExpenses > 0 && (
              <div className="rounded-xl border border-ink-200/60 bg-ink-50/70 p-2">
                <p className="text-xs text-ink-500 dark:text-ink-400">{t(language, 'expense')}</p>
