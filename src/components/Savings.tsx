  ...
  return (
    <section className="card card-pad mb-6">
      <div className="flex flex-wrap items-center justify-between gap-3 mb-4">
        <h2 className="section-title font-heading">{t(language, 'savings')}</h2>
        <div className="relative flex items-center gap-3">
          ...
          <div className="rounded-full border border-teal-200/60 bg-teal-50/70 px-4 py-2 dark:bg-teal-500/10 dark:border-teal-500/30">
            ...
            <span className="ml-2 text-sm font-bold text-teal-800 dark:text-teal-300">{formatCurrency(getTotalSavings())}</span>
          </div>
          <ConfirmToast
            open={confirmOpen}
            message={t(language, 'confirmClearSavings')}
